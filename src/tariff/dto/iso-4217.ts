// Active ISO 4217 alphabetic currency codes, per the ISO 4217 Maintenance Agency (SIX
// Financial Information AG) "List One: Current Currency & Funds", amendments through
// #180 (22 Sept 2025 — Bulgarian lev retired for EUR from 2026-01-01). Includes the
// supranational fund/settlement codes (XAU, XDR, XTS, XXX, ...) the standard itself
// still lists as active. Source: https://www.six-group.com/en/products-services/financial-information/data-standards.html
...
export const ISO_4217_CODE_SET: ReadonlySet<string> = new Set(ISO_4217_CODES)
